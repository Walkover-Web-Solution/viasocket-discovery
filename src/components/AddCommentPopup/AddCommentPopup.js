  ...
  return (
    <Dialog open={open} onClose={onClose} maxWidth={false}>
      <ClickAwayListener onClickAway={onClose}>
        <div
          className="position-relative bg-white border shadow-lg p-4"
          role="dialog"
          aria-modal="true"
          ...
          <form onSubmit={onSubmit}>
            <fieldset className="border-0 p-0 m-0 mb-4">
              ...
              >
                <div className="col-12 col-md-6">
                  <label
                    className={optionClass(isAppOption)}
                    style={optionStyle(isAppOption)}
                  >
                    <input
                      type="radio"
                    ...
                    <span className="flex-grow-1">
                      ...
                      <span className="text-secondary small">
                        Submit a product for editorial review and potential
                        inclusion in future Discovery coverage.
                      </span>
                    </span>
                    <span
                ...
                <div className="col-12 col-md-6">
                  ...
                  >
                    ...
                    <span className="flex-grow-1">
                      ...
                      <span className="text-secondary small">
                        Share a correction, editorial suggestion, issue, or
                        request for additional product coverage.
                      </span>
                    </span>
                    <span
                      className="rounded-circle border border-2 flex-shrink-0"
            ...
            <div className="border-top pt-3 mb-4">
              ...
              <div className="d-flex justify-content-between align-items-end gap-3 mt-3">
                ...
                >
                  We review every submission manually. Selected apps may be
                  researched and featured in future editorial roundups.
                </p>
