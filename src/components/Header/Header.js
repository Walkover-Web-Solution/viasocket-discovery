...
const Header = () => {
  ...
  const loginUrl =
    getCurrentEnvironment() !== "prod"
      ? "http://localhost:3000/automation-ideas/auth"
      : "https://viasocket.com/login?redirect_to=/automation-ideas/auth&utm_source=/automation-ideas";
  const signupUrl =
    getCurrentEnvironment() !== "prod"
      ? "http://localhost:3000/automation-ideas/auth"
      : "https://viasocket.com/signup?redirect_to=/automation-ideas/auth&utm_source=/automation-ideas";

  return (
    <div className="header-container border-bottom p-3">
      <header
        className={
          "d-flex justify-content-between align-items-center w-100 w-md-75 mx-auto "
        }
      >
        <a
        ...
        <nav className="d-flex align-items-center via-menu-lg">
          ...
          {!isLoggedIn ? (
            <>
              ...
              <a
                href={signupUrl}
                className="px-4 text-white text-decoration-none btn rounded-pill d-flex justify-content-center"
                onClick={handleAuth}
                style={{
                  minWidth: "120px",
                  fontSize: "14px",
